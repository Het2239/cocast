    ...
    <section className="pt-24 pb-16 md:pt-32 md:pb-24 overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row md:items-center gap-8">
          ...
          >
            <span className="inline-block text-sm font-medium text-cocast-darkSage mb-4 tracking-wider">
              NATURE'S TOUCH IN EVERY DROP
            </span>
            ...
            <p className="text-lg text-cocast-brown/80 mb-8 max-w-lg">
              Discover our collection of all-natural personal care products, crafted with sustainable
              ingredients that care for your skin and our planet.
            </p>
          ...
          >
            <div className="relative">
              <Link to="/products">
                <img
                  src="/media/soap-all-1.jpeg"
                  alt="Cocast Soap Collection"
                  className="rounded-2xl shadow-xl w-full h-auto object-cover"
                />
              </Link>
              <div className="absolute -bottom-4 -left-4 w-32 h-32 bg-cocast-lightSage rounded-full -z-10" />
              <div className="absolute -top-4 -right-4 w-24 h-24 bg-cocast-beige rounded-full -z-10" />
            </div>
          </motion.div>
        </div>
      </div>
